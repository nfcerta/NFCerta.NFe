...
namespace NFCerta.NFe.Schemas.Cancelamento
{
    ...
    public partial class EventoCancelamento : ITemAssinatura
    {
        ...
        private static System.Xml.Serialization.XmlSerializer Serializer
        {
            get
            {
                if ((serializer == null))
                {
                    serializer = new System.Xml.Serialization.XmlSerializer(typeof(EventoCancelamento));
                }
                return serializer;
            }
        }
        ...
        public static bool Deserialize(string xml, out EventoCancelamento obj, out System.Exception exception)
        {
            exception = null;
            obj = default(EventoCancelamento);
            try
            {
                obj = Deserialize(xml);
                return true;
        ...
        public static bool Deserialize(string xml, out EventoCancelamento obj)
        {
            System.Exception exception = null;
            return Deserialize(xml, out obj, out exception);
        }

        public static EventoCancelamento Deserialize(string xml)
        {
            System.IO.StringReader stringReader = null;
            try
            {
                stringReader = new System.IO.StringReader(xml);
                return ((EventoCancelamento)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
            }
            finally
            {
        ...
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool LoadFromFile(string fileName, System.Text.Encoding encoding, out EventoCancelamento obj, out System.Exception exception)
        {
            exception = null;
            obj = default(EventoCancelamento);
            try
        ...
        public static bool LoadFromFile(string fileName, out EventoCancelamento obj, out System.Exception exception)
        {
            return LoadFromFile(fileName, Encoding.UTF8, out obj, out exception);
        }

        public static bool LoadFromFile(string fileName, out EventoCancelamento obj)
        {
            System.Exception exception = null;
            return LoadFromFile(fileName, out obj, out exception);
        }

        public static EventoCancelamento LoadFromFile(string fileName)
        {
            return LoadFromFile(fileName, Encoding.UTF8);
        }

        public static EventoCancelamento LoadFromFile(string fileName, System.Text.Encoding encoding)
        {
    ...
    public partial class TEventoInfEvento
    {
        ...
        [EditorBrowsable(EditorBrowsableState.Never)]
        private TipoEvento tpEventoField;

        [EditorBrowsable(EditorBrowsableState.Never)]
        private string nSeqEventoField;

        [EditorBrowsable(EditorBrowsableState.Never)]
        private VersaoEvento verEventoField;
    ...
    public partial class TEventoInfEventoDetEvento
    {
        ...
        [EditorBrowsable(EditorBrowsableState.Never)]
        private DescricaoDetalheEvento descEventoField;
        ...
        [EditorBrowsable(EditorBrowsableState.Never)]
        private VersaoDetalheEvento versaoField;

        private static System.Xml.Serialization.XmlSerializer serializer;

        [System.Xml.Serialization.XmlElementAttribute(Order = 0)]
        public DescricaoDetalheEvento descEvento
        {
            get
            {
        ...
        [System.Xml.Serialization.XmlAttributeAttribute()]
        public VersaoDetalheEvento versao
        {
            get
            {
    ...
    [System.SerializableAttribute()]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true, Namespace = "http://www.portalfiscal.inf.br/nfe")]
    public enum DescricaoDetalheEvento
    {
    ...
    [System.SerializableAttribute()]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true, Namespace = "http://www.portalfiscal.inf.br/nfe")]
    public enum VersaoDetalheEvento
    {
